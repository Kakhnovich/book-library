    ...
    <c:choose>
        <c:when test="${!sort.equals('accept')}">
            <form method="post" action="${pageContext.request.contextPath}/controller?sort=accept">
                <button class="btn btn-secondary" type="submit">Show only available now books</button>
            </form>
        </c:when>
        <c:otherwise>
            <form method="post" action="${pageContext.request.contextPath}/controller?command=main">
                <button class="btn btn-secondary" type="submit">Show all books</button>
            </form>
        </c:otherwise>
    </c:choose>
    <jsp:include page="bookList.jsp"/>
    <jsp:include page="pagination.jsp"/>
    <a class="btn btn-secondary" href="${pageContext.request.contextPath}/controller?command=book">Add</a>
</div>
</body>
</html>