...
public class Book {
    ...
    Book(int isbn, String coverLink, String title, List<String> authors, String publisher, LocalDate publishDate, List<String> genres, int pageCount, String description, int totalAmount) {
        this.isbn = isbn;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(isbn, coverLink, title, authors, publisher, publishDate, genres, pageCount, description, totalAmount);
    }
}
